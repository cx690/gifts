    ...
    >
      ...
      >
        ...
        <a-form-model-item prop="desc" label="备注">
          <a-textarea :maxLength="200" v-model="addForm.desc" style="resize:none;width:400px;height:100px" placeholder="备注" class="input" />
        </a-form-model-item>
      </a-form-model>
    </a-modal>
  </div>
  ...
  methods: {
    ...
    add(current = null) {
      ...
      if (current) {
        ...
        this.addForm = { price, desc, name, id };
      } else {
        this.addForm = { price: 0, desc: "", name: "" };
      }
    },
    onBlur(){
